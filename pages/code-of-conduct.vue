<template>
  <div class="page">
    <HeroBanner color="blue"
      ><h1><span>Our Culture</span></h1></HeroBanner
    >
    <h3 class="intro">Contributor Covenant Code of Conduct</h3>
    <section>
      ...
      <p>
        ...
        welcoming, diverse, transparent, honest, good intentioned, inclusive,
      ...
      <p>
        ...
        sending a direct message to any of the Discord Mods in
        <a href="https://discord.leaderboards.gg">our discord</a>. All
